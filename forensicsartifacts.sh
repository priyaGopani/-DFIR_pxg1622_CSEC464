...
function outtocsv(){
	getTime >> output.csv
	getOSVersion >> output.csv
	getHardware >> output.csv
	getHostDomain >> output.csv
	getUsers >> output.csv
	getstartatboot >> output.csv
	getscheduledtasks >> output.csv
	getnetwork >> output.csv
	getprinter >> output.csv
	getprocesses >> output.csv
	getdrivers >> output.csv
	getfiles >> output.csv
	getcustom >> output.csv
